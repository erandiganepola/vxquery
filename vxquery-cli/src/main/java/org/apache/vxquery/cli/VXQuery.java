...
/**
 * CLI for VXQuery. This class is using the REST API to execute statements given
 * by the user.
 *
...
public class VXQuery {
	...
	/**
	 * Submits a query to be executed by the REST API. Will call
	 * {@link #onFailure(String, ErrorResponse)} if any error occurs when submitting
	 * the query. Else will call
	 * {@link #onSuccess(String, QueryRequest, SyncQueryResponse)} with the
	...
	/**
	 * Once the query in a given .xq file has been executed (with repeated
	 * executions as well), this method calculates mean, standard deviation, minimum
	...
	/**
	 * Reads the contents of file given in query into a String. The file is always
	 * closed. For XML files UTF-8 encoding is used.
	 *
	 * @param query
